...
export class HomePage implements OnInit {
  ...
  public nivelesEducacionales: NivelEducacional[] = [
    {id: 1, nombre: 'Final fantasy 7 remake'},
    {id: 2, nombre: 'Horizont'},
    {id: 3, nombre: 'The last of us'},
    {id: 4, nombre: 'God of war'},
    {id: 5, nombre: 'Resident evil 3 remake'},
    {id: 6, nombre: 'Jump force'}
  ];
...
public ngOnInit() {
  this.persona.nombre = 'Ingresa tu nombre';
  this.persona.apellido = 'Ingresa tu apellido';
  this.persona.nivelEducacional.id = 6;
  this.persona.fechaNacimiento = '1989-12-23';
}
  ...
  */
  ...
  public mostrarDatosPersona(): void {
    ...
    const mensaje =
      ...
      + '<br>Video juego: ' + this.persona.nivelEducacional.id + ' - '
